...
export function DashboardAdmin() {
  ...
  const {stats, locataireSearchTerm, setLocataireSearchTerm, logements, locataires, setLogementSearchTerm, logementSearchTerm} = useDashboard()
  ...
  {
    openModal(updateContractModal, contract)
  }
      ...
      <div className="p-4 sm:p-6 w-full mx-auto">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex justify-center items-center flex-col ">
              <div className="flex-grow">
                <div className="">
                {!(stats.contratsActifs == 0 && stats.contratsTermines == 0, stats.contratsFutur == 0) ? <Doughnut
                    data={{
                        labels: ['contrats actifs', 'contrats terminés', 'contrats futur'],
                        datasets:[
                            {
                              label: "Contrats",
                              data: [stats.contratsActifs, stats.contratsTermines, stats.contratsFutur],
                              backgroundColor: [
                                  "#FBBB00",
                                  "#F14336",
                                  "#bffee4"
              ...
              <div className="">
                <div className="my-2 flex justify-start gap-1.5">
                  ...
                  <p className="font-bold text-[#FBBB00] w-[15px]">{stats.contratsActifs}</p>
                </div>
        ...
        <div>
          ...
          >
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0 mb-4">
                ...
                <div className="flex items-center mt-4 md:gap-2 sm:mt-0 w-full justify-center">
                  ...
                  <select
                    ...
                    onChange={(e) => setSelectedFilter(e.target.value)} style={{height: "40px", padding: "0 5px"}}
                  >
            ...
            {console.log(stats)}
            { (locataires  && locataires.length) > 0  ? locataires.map((locataire) => (
            <div
                key={locataire.id}
            ...
            >
                <div className="flex items-center md:ms-8 text-center w-full md:w-auto justify-center md:justify-start">
                  <img
                      src={locataire.image ? `http://localhost:8000/storage/${locataire.image}` : "http://localhost:5173/images/team2.jpg"}
                      alt={locataire.name}
                ...
                {computeDuration(locataire.contracts[0].date_debut, locataire.contracts[0].date_fin)}
                </div>
                <div className="w-full md:w-auto  md:text-start text-center">
                  <span
                      ...
                      locataire.contracts[0].statut === "en_cours"
                          ...
                          : locataire.contracts[0].statut === "à_venir" ? "bg-[#bffee4] text-gray-700" : "text-gray-700 bg-red-500" 
                      }`}
                  >
                ...
                <div className="w-full md:w-auto text-center">
                <button onClick={()=>openModal(updateContractModal, locataire)} className="text-gray-500 hover:text-green-500">
