...
import { SendNotificationModal } from "../../containers/modals.jsx/SendNotificationModal";
          ...
          <div className="mt-5">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex items-center justify-center flex-row gap-3">
                  ...
                  <button
                  onClick={() => openModal(SendNotificationModal)}
                  className="bg-green-500 text-white px-4 py-2 rounded-md flex items-center text-sm hover:bg-green-600 transition-colors"
                  >
            ...
            >
              ...
              {(prospects && prospects.length) > 0 ? (
                prospects.map((prospect) => (
                  <div
                    key={prospect.id}
                    className="flex flex-col md:grid md:grid-cols-4 gap-4 py-3 items-center border-b md:border-0"
                  >
                    <div className="flex items-center md:ms-8 text-center w-full md:w-auto justify-center md:justify-start">
                      <img
                        src={
