...
{
    return <button className="p-5 mb-4 mt-2 h-[44px] bg-(--primary-green) rounded-3xl min-w-max lg:w-fit text-white cursor-pointer flex items-center justify-center gap-2">
        {children}
    </button>
}
